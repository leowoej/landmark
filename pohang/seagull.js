export class Seagull {
    constructor(img, stageWidth){
        ...
        this.imgWidth = 1920/9;
        this.imgHeight = 213;

        this.seagullWidth =1920/9/2/1.5;
        this.seagullHeight =213/2/1.5;

        this.seagullWidthHalf = this.seagullWidth / 2;
        this.x = stageWidth + this.seagullWidth;
        this.y = 0;
    ...
    animate(ctx, dots){
        ...
        ctx.drawImage(  // 양 이미지 그려주는 함수
            ...
            this.imgWidth,
            this.imgHeight,
            -this.seagullWidthHalf, 
            -this.seagullHeight +20,
            this.seagullWidth,
            this.seagullHeight
        );
